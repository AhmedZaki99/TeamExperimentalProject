...
ALTER TABLE [Users] ALTER COLUMN [LastSignedIn] datetime2(6) NULL;
GO
...
ALTER TABLE [Users] ALTER COLUMN [DateCreated] datetime2(6) NOT NULL;
GO
...
ALTER TABLE [Users] ALTER COLUMN [BirthDate] datetime2(3) NOT NULL;
GO
...
ALTER TABLE [Posts] ALTER COLUMN [DatePosted] datetime2(6) NOT NULL;
GO
...
ALTER TABLE [Comments] ALTER COLUMN [DatePosted] datetime2(6) NOT NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220304233128_AddDatePrecision', N'6.0.2');
GO
